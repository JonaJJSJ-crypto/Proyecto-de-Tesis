...
Decay_lwe__minus__ = Decay(name = 'Decay_lwe__minus__',
                           ...
                           partial_widths = {(P.Z,P.e__minus__):'((Mlwe**2 - MZ**2)*(0. + (6.944444444444446e-13*ee**2*Mlwe**2)/(cw**2*sw**2) + (6.944444444444446e-13*ee**2*Mlwe**4)/(cw**2*MZ**2*sw**2) - (1.3888888888888893e-12*ee**2*MZ**2)/(cw**2*sw**2)))/(32.*cmath.pi*abs(Mlwe)**3)'})
...
Decay_Z = Decay(name = 'Decay_Z',
                ...
                partial_widths = {(P.b,P.b__tilde__):'((-7*ee**2*MB**2 + ee**2*MZ**2 - (3*cw**2*ee**2*MB**2)/(2.*sw**2) + (3*cw**2*ee**2*MZ**2)/(2.*sw**2) - (17*ee**2*MB**2*sw**2)/(6.*cw**2) + (5*ee**2*MZ**2*sw**2)/(6.*cw**2))*cmath.sqrt(-4*MB**2*MZ**2 + MZ**4))/(48.*cmath.pi*abs(MZ)**3)',
                                  ...
                                  (P.e__minus__,P.lwe__plus__):'((-Mlwe**2 + MZ**2)*(0. - (6.944444444444446e-13*ee**2*Mlwe**2)/(cw**2*sw**2) - (6.944444444444446e-13*ee**2*Mlwe**4)/(cw**2*MZ**2*sw**2) + (1.3888888888888893e-12*ee**2*MZ**2)/(cw**2*sw**2)))/(48.*cmath.pi*abs(MZ)**3)',
                                  (P.lwe__minus__,P.e__plus__):'((-Mlwe**2 + MZ**2)*(0. - (6.944444444444446e-13*ee**2*Mlwe**2)/(cw**2*sw**2) - (6.944444444444446e-13*ee**2*Mlwe**4)/(cw**2*MZ**2*sw**2) + (1.3888888888888893e-12*ee**2*MZ**2)/(cw**2*sw**2)))/(48.*cmath.pi*abs(MZ)**3)',
